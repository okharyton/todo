class TodoList {
  constructor() {
    ...
    this.showCompletedTasksBtn = document.querySelector(
  ...
  addEventListeners() {
    ...
    this.showCompletedTasksBtn.addEventListener(
      "click",
      this.showCompletedTasks.bind(this)
    );
    this.showAllTasksBtn.addEventListener(
      "click",
    ...
    taskItem.innerHTML = `
      <div class="task__container">
        <div class="task-line">
          ...
          <label class="task-label" data-task-id="${task.id}">${
      task.name
    }</label>
        </div>
        <div class="buttons">
